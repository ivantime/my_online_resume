...
date: 2022-07-07
summary: Multi-Line Charts of COVID-19 Cases
tags: [Data Engineering, Software Engineering]
role: Solo Project
tools: [Python, CSV, HTML/CSS, JavaScript]
cover: /img/covid_line_chart_headline_gif.gif
coverScale: 50
coverAlt: COVID_GIF
---
<a href="https://upload.wikimedia.org/wikipedia/commons/c/c5/Covid-19-curves-graphic-social-v3.gif?utm_source=commons.wikimedia.org&utm_campaign=index&utm_content=original" style="font-size: 20%;">Image Source</a> 
From Cluttered Chart to Interactive Drill-Through Chart

## The Problem

```pdf src="/files/project_slide_demo.pdf" page="4" width="90%" ratio="16/9" title="" caption="Slide 4 of the project deck." interactive="false"
```
...
![alt text](../images/covid_line_chart_1_the_elephant_2.gif)
...
![alt text](../images/covid_line_chart_3_revamp_improvements_text_cut_off.png)
